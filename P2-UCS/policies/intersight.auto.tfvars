...
tfc_workspaces = [{
  backend             = "remote"
  tfc_organization    = "GET"
  domain_profiles_dir = null
  domain_profiles_ws  = "P2-UCS_ucs_domain_profiles"
  pools_dir           = null
  pools_ws            = "P2-UCS_pools"
}]
...
tags = [{ key = "Module", value = "terraform-intersight-easy-imm" }, { key = "Version", value = "1.5.4" }]